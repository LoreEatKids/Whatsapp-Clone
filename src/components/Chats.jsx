                ...
                <div className="chat__infos d-f s-b">
                  ...
                  <div className="chat__menage">
                    ...
                    <div className="chat__remove">
                      <FontAwesomeIcon icon={faTrash} onClick={() => handleDeleteGroup(chat)} />
                    </div>
                  </div>
