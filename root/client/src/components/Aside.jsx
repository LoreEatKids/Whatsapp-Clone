...
export default function Aside() {
    ...
    return (
        <aside>
            {groupMenuActive && <NewGroup setActive={setGroupMenuActive} setSettingsActive={setGroupSettingsActive} groupSearchResults={groupSearchResults} setGroupSearchResults={setGroupSearchResults} />}
            {groupSettingsActive && <NewGroupSettings setSettingsActive={setGroupSettingsActive} setActive={setGroupMenuActive} />}
